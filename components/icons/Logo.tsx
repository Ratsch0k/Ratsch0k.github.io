...
const Logo: Component = ({className, id, style}) => {
  return (
    <svg className={className} id={id} style={style}  color="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 987.46 938.07">
      <path className="a"
            style={{
              fill: 'none',
              stroke: 'currentcolor',
